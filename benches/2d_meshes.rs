//! Measure calculating the meshes from a 2d vornoi that was derived from a 2d delaunay
//!
...
fn prepare_data() -> Voronoi2d {
	...
	let voronoi = Voronoi2d::from_delaunay_2d(&data);
	voronoi.unwrap()
}

/// Call the code to benchmark
fn init(voronoi: &Voronoi2d) {
	let _m = voronoi.as_bevy2d_meshes();
}
/// Benchmark
pub fn criterion_benchmark(c: &mut Criterion) {
	...
	group.bench_function("2d_meshes", |b| b.iter(|| init(black_box(&data))));
	group.finish();
}
